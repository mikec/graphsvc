...
GraphSvc.prototype.createConnection = function(baseEntityIndexName, baseEntityKeyValue, connEntityIndexName, connEntityData, relName, options) {
	...
	return (function() {
		if(options.runBefores) {
			var data = {};
			data[baseEntityDef.name] = {}
			data[baseEntityDef.name][baseEntityDef.key] = baseEntityKeyValue;
			...
			data[connEntityDef.name] = connEntityData;
		...
		/*
		// copy values that will be written to the database, as they may have been modified in a before process
		if(data) {
			connEntityData = 
		}*/
